...
<div class="row-fluid sortable">
    <div class="col-md-12" style="padding: 40px;">
        <ul class="breadcrumb">
            ...
            <li>
                <i class="icon-edit"></i>
                <a href="#">Editar Loja</a>
            </li>
        </ul>
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Editar Loja</h2>
        </div>
        <div class="box-content">
            ...
            <form role="form" action="{{url('/update-store/'.$store_info->store_id)}}" method="post">
                {{ csrf_field() }}
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="number" class="form-control" name="store_vat" value="{{$store_info->store_vat}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            ...
                            @if($store_info->publication_status==1)
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">Editar Loja</button>
